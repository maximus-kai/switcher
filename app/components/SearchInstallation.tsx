...
const SearchInstallation = () => {
  return (
    <form className='border flex flex-row  w-fit justify-between h-full relative rounded-full '>
      ...
      <button className="px-4 py-2 bg-orange-800 text-xl absolute right-[4px] top-[8%] text-white rounded-full  hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 border-white shadow">Find</button>
    </form>
  )
}
